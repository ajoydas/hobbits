MIN_DEPOSIT_AMOUNT: constant(uint256) = 100000000  # Gwei
FULL_DEPOSIT_AMOUNT: constant(uint256) = 3200000000  # Gwei
CHAIN_START_FULL_DEPOSIT_THRESHOLD: constant(uint256) = 6  # 2**16
